...
$this->response(array('status' => "failed", "message"=>"Id Pembeli harus diisi"));
	...
	{
		$this->response(array('status' => "failed", "message"=>"nama harusdiisi"));
	}else if (empty($data_pembeli['alamat'])){
		$this->response(array('status' => "failed", "message"=>"alamat harusdiisi"));
	}else if (empty($data_pembeli['telpn'])){
		$this->response(array('status' => "failed", "message"=>"telpn harusdiisi"));
}
else{
...
if (!empty($_FILES)){
	if ($_FILES["photo_id"]["name"]) {
		...
		else{$data_pembeli['photo_id'] = "";$insert_image = "Image Tidak ada Masukan";
	}
