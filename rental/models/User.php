...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        //var_dump(static::findOne(['id' =>$id])) or die; 
    ...
    {
     //   var_dump(static::findOne(['username' => $username])) or die;
    ...
    {
        // var_dump(Yii::$app->security->validatePassword($password, $this->password)) or die;
    ...
    {
       $data  = $this->password= Yii::$app->security->generatePasswordHash($password);
    ...
    public function getLinkPreviewAvatar()
    {
        ...
        if(!is_null($this->avatar) AND !empty($this->avatar))
            ...
            return Yii::getAlias('@web').'/img/dummy/u1.png';
    }
